...
namespace SchumacherFM\Anonygento\Model\Zend\Console\Adapter;

use ReflectionClass;
use SchumacherFM\Anonygento\Model\Zend\Console\Charset;
use SchumacherFM\Anonygento\Model\Zend\Console\Exception;
use SchumacherFM\Anonygento\Model\Zend\Console\Color\Xterm256;
use SchumacherFM\Anonygento\Model\Zend\Console\ColorInterface as Color;
        ...
        if ($color !== null) {
            if (!isset(static::$ansiColorMap[$type][$color])) {
                throw new Exception\BadMethodCallException(sprintf(
                        'Unknown color "%s". Please use one of the Zend\Console\ColorInterface constants or use SchumacherFM\Anonygento\Model\Zend\Console\Color\Xterm256::calculate',
                        $color
                ));
            }
